export default function createWebinar() {
    ...
    it('Visitin admin', function() {
        ...
        //visiting eRoom > Webinars in wp admin
    it('Visiting eRoom > Webinars', function() {
        ...
        //adding new webbinar
    it('Adding new webinar', function() {
            cy.get('.wrap > [href="http://localhost/lms.loc/wp-admin/post-new.php?post_type=stm-zoom-webinar"]').click()
        })
        //creating new webinar
    it('Creating webinar', function() {
        //typing webinar's title
        cy.get('#title').type('Test webinar')
            //typing webinar's description
        ...
        cy.get('[title="16.03.2021"]' /*<< DATE*/ ).click()
            //selecting timezone
        cy.get('#tab_1-stm_timezone').select('Asia/Tashkent')
            //inputing time
        cy.get('#tab_1-stm_time').type('09:00' /*<< TIME*/ )
    ...
    it('Visiting created webinar', function() {
        //visiting meeting url
        cy.get('#sample-permalink > a').click()
            //countdown assertion exist or not
        cy.get('.stm_zooom_countdown').should('exist')
